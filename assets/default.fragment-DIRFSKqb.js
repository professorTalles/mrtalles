import{z as e}from"./index-nDQ7wKK0.js";import{s as q,m as j,d as Z,a as Q,l as J}from"./logDepthDeclaration-DCyVI8Gz.js";import{h as K}from"./helperFunctions-BLVhgWMk.js";import{c as ee,f as re,a as te,b as ae}from"./fogFragment-DSOBpSME.js";const t="prePassDeclaration",I=`#ifdef PREPASS
...
`;e.ShadersStoreWGSL[E]||(e.ShadersStoreWGSL[E]=$);const De=[q,j,Z,ie,oe,Q,K,fe,ne,se,le,de,ce,ve,ue,pe,he,me,Se,ge,xe,ee,J,re,te,Te,Le,Ce,we,Ee,ae,Ie];for(const r of De)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const _e={name:E,shader:$};export{_e as defaultPixelShaderWGSL};
